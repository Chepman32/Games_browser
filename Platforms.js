...
export function Platforms({ query, name }) {
  useEffect(() => {
  ...
  async function getData() {
    ...
    let response =
    await fetch(
      `https://api.rawg.io/api/games?page=${page}&platforms=${query}`);
...
export default function PlatformsContainer({route}) {
  ...
  return (
    <Platforms query={query} name={name} />
  )
}
